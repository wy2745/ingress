...
func NewNamespaceBasedEnricher(client clientset.Interface) (*NamespaceBasedEnricher, error) {
	// watch nodes
	lw := cache.NewListWatchFromClient(client.Core().RESTClient(), "namespaces", kube_api.NamespaceAll, fields.Everything())
